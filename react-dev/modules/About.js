...
export default React.createClass({
  render() {
    ...
    <div className="about">
      <h1>Segunda Mano</h1>
      <p>En respuesta a la incertidumbre sobre la evolución del mercado a causa de la crisis, los consumidores empiezan a adoptar alternativas para afrontar las dificultades económicas. 
Se consume de forma más consciente: un 7% de los consumidores europeos prefieren ahorrar antes que consumir.
</p><p>Los mercados de segunda mano en la sociedad actual es digna de ser analizada. Sobre todo porque la alternativa que ofrecen estas tiendas, que canalizan conceptos como reinventar, reaprovecha y reciclar con creatividad, parece ser la solución clave para sobrevivir en el negocio.
</p>
